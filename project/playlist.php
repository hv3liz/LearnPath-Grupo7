   ...
   <div class="row">
      ...
      <div class="col">
         <form action="" method="post" class="save-list">
            ...
            ?>
            <button type="submit" name="save_list"><i class="fas fa-bookmark"></i><span>Visto</span></button>
            <?php
               }else{
            ?>
               <button type="submit" name="save_list"><i class="far fa-bookmark"></i><span>Dar vista</span></button>
            <?php
               }
            ?>
         </form>
         <div class="thumb">
            <span><?= $total_videos; ?> contenido</span>
...
<section class="videos-container">
   ...
   <div class="box-container">
      ...
      <?php
            ...
            echo '<p class="empty">No contenido agregado</p>';
         }
      ?>
