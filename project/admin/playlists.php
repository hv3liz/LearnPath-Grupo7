...
<section class="playlists">
   ...
   <h1 class="heading">Agregar modulos</h1>

   <div class="box-container">
   
      <div class="box" style="text-align: center;">
         <h3 class="title" style="margin-bottom: .5rem;">Crear nuevo modulos</h3>
         <a href="add_playlist.php" class="btn">Agregar</a>
      </div>
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="update_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">Actualizar modulo</a>
            <input type="submit" value="eliminar" class="delete-btn" onclick="return confirm('Eliminar este modulo?');" name="delete">
         </form>
         <a href="view_playlist.php?get_id=<?= $playlist_id; ?>" class="btn">Ver modulo</a>
      </div>
      <?php
         } 
      }else{
         echo '<p class="empty">No hay modulos creados</p>';
      }
      ?>
