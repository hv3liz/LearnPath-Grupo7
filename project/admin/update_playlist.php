...
<section class="playlist-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>Estado del modulo <span>*</span></p>
      ...
      <div class="flex-btn">
         <input type="submit" value="delete" class="delete-btn" onclick="return confirm('Desea eliminar este modulo');" name="Eliminar">
         <a href="view_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">Ver modulo</a>
      </div>
   </form>
   <?php
      } 
