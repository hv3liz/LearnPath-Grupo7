...
<section class="dashboard">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p>Contenidos publicados</p>
         <a href="add_content.php" class="btn">Agregar nuevos contenidos</a>
      </div>

      <div class="box">
         <h3><?= $total_playlists; ?></h3>
         <p>total de modulos</p>
         <a href="add_playlist.php" class="btn">Agregar modelos</a>
      </div>
