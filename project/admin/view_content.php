   ...
   <div class="container">
      ...
      <form action="" method="post">
         <div class="flex-btn">
            ...
            <input type="submit" value="Eliminar" class="delete-btn" onclick="return confirm('Desea eliminar este contenido?');" name="delete_video">
         </div>
      </form>
   </div>
   <?php
...
<section class="comments">
   ...
   <div class="show-comments">
      ...
      <?php
         ...
         echo '<p class="empty"> Aun no hay comentarios!</p>';
      }
      ?>
      </div>
