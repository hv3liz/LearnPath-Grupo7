...
<section class="contents">
   ...
   <div class="box" style="text-align: center;">
      <h3 class="title" style="margin-bottom: .5rem;">Crear contenido</h3>
      <a href="add_content.php" class="btn">Agregar contenido</a>
   </div>
   ...
   ?>
      <div class="box">
         ...
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="btn">ver contenido</a>
      </div>
   <?php
         }
      }else{
         echo '<p class="empty">No hay contenido agregados</p>';
      }
   ?>
