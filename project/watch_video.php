...
<section class="watch-video">
   ...
   <div class="video-details">
      ...
      <form action="" method="post" class="flex">
         ...
         <a href="playlist.php?get_id=<?= $fetch_content['playlist_id']; ?>" class="inline-btn">Ver modulos</a>
         <?php
            if($verify_likes->rowCount() > 0){
         ?>
         <button type="submit" name="like_content"><i class="fas fa-heart"></i><span>Me encanta</span></button>
         <?php
         }else{
         ?>
...
<section class="comments">
   ...
   <h1 class="heading">Agregar comentario</h1>

   <form action="" method="post" class="add-comment">
      <input type="hidden" name="content_id" value="<?= $get_id; ?>">
      <textarea name="comment_box" required placeholder="Digita tu ensayo..." maxlength="1000" cols="30" rows="10"></textarea>
      <input type="submit" value="Adjuntar comentario" name="add_comment" class="inline-btn">
   </form>

   <h1 class="heading">Ensayos de estudiantes</h1>
   ...
   <div class="show-comments">
      ...
      <div class="box" style="<?php if($fetch_comment['user_id'] == $user_id){echo 'order:-1;';} ?>">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <button type="submit" name="edit_comment" class="inline-option-btn">Editar</button>
            <button type="submit" name="delete_comment" class="inline-delete-btn" onclick="return confirm('delete this comment?');">Eliminar</button>
         </form>
         <?php
         }
         ?>
